...
function attachAsyncSQLite(sqlite) {
if (typeof sqlite.execAsync !== 'function') sqlite.execAsync = statement => Promise.resolve(sqlite.exec(statement))
const originalPrepare = sqlite.prepare.bind(sqlite)
sqlite.prepare = statement => {
const prepared = originalPrepare(statement)
if (typeof prepared.runAsync !== 'function') prepared.runAsync = (...args) => Promise.resolve(prepared.run(...args))
if (typeof prepared.getAsync !== 'function') prepared.getAsync = (...args) => Promise.resolve(prepared.get(...args))
if (typeof prepared.allAsync !== 'function') prepared.allAsync = (...args) => Promise.resolve(prepared.all(...args))
return prepared
}
return sqlite
}
...
const sqlite = attachAsyncSQLite(new Database(dbPath))
